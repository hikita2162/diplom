...
def test_search(chrome):
    ...
    chrome.find_element(By.NAME, "kp_query").send_keys("Троя")
    chrome.find_element(By.ID, "suggest-item-film-397667").click()
    assert chrome.find_element(By.CSS_SELECTOR, "span[data-tid='75209b22']").text == "Троя (2004)"
...
def test_search_english(chrome):
    chrome.get("https://www.kinopoisk.ru/")
    chrome.find_element(By.NAME, "kp_query").send_keys("Troy")
    chrome.find_element(By.ID, "suggest-item-film-397667").click()
    assert chrome.find_element(By.CSS_SELECTOR, "span[data-tid='75209b22']").text == "Троя (2004)"
...
def test_actors(chrome):
    chrome.get("https://www.kinopoisk.ru/")
    chrome.find_element(By.NAME, "kp_query").send_keys("Дмитрий Нагиев")
    chrome.find_element(By.ID, "suggest-item-person-25584").click()
    assert chrome.find_element(By.CSS_SELECTOR, "span[data-tid='f22e0093']").text == "Дмитрий Нагиев"